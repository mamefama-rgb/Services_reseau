    ...
    if (empty($username) || empty($password) || empty($email)) {
        ...
        try {
            ...
            if ($stmt->execute([$username, $hashed_password, $email, $role])) {
                // Ici, vous pouvez créer un répertoire local si nécessaire
                // Exemple : mkdir("repertoires/$email", 0777, true);
...
function sendConfirmationEmail($to, $username, $password) {
    ...
    <body>
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 5px;">
            ...
            <p>Pour des raisons de sécurité, nous vous recommandons de changer votre mot de passe après votre premiére connexion.</p>
                  ...
                  <?php if ($error): ?>
                    ...
                    <?php endif; ?>
                        <form action="" method="post">
                            ...
                            <div class="mb-3">
                                <label for="role" class="form-label" id="role">Rôle</label>
